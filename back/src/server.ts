...
// import { resolvers } from "./presentation/controllers/montadoras.resolver";
...
async function startApolloServer() {
  ...
  app.listen(4000, () => {
    ...
    console.log(
      "📌 GraphQL Playground: http://localhotypeorm migration:generate src/persistence/typeorm/migrations/AddMontadorast:4000/graphql"
    );
  });
}
